/* ════════════════════════════════════════════════════════════
   Inline SVG Icons — Web 子分支精简版（从桌面端 icons.tsx 抽取）
   ════════════════════════════════════════════════════════════ */
...
export function IconSearch5({ className = "w-5 h-5" }: { className?: string }) {
  return (
...
export function IconImageSearch() {
  return (
...
export function IconCar() {
  return (
    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M3 15h18v3a1 1 0 01-1 1h-2a1 1 0 01-1-1v-1H7v1a1 1 0 01-1 1H4a1 1 0 01-1-1z" />
...
export function IconText() {
  return (
    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <polyline points="9 20 12 20 15 20" />
    </svg>
  );
}
